<!--Este layout es el layout principal para el formulario de iniciar sesión y de registro -->
<!DOCTYPE html>
<html>
...
<head>
  ...
  <!-- Argon CSS -->
  <link type="text/css" href="{{ secure_secure_asset('css/argon.css?v=1.0.0') }}" rel="stylesheet">
</head>
    ...
    <nav class="navbar navbar-top navbar-horizontal navbar-expand-md navbar-dark">
      <div class="container px-4">
        <a class="navbar-brand" href="{{ url('/') }}">
          <img src="{{ secure_asset('/img/brand/labscom_white.png') }}" class="navbar-brand-img" alt="...">
        </a>
