...
@section('subtitle', 'Ingresa tus datos para iniciar sesión como alumno')
            ...
            <form method="POST" action="{{ route('student.check') }}">
              ...
              <div class="form-group mb-3">
                <div class="input-group input-group-alternative">
                  ...
                  <input class="form-control" placeholder="Número de boleta" type="text" name="num_boleta" value="{{ old('num_boleta') }}" required>
                </div>
              </div>
        ...
        <div class="row mt-3">
          ...
          <div class="col-6 text-right">
            <a href="{{ route('student.register') }}" class="text-light">
                <small>¿Aun no te has registrado?</small></a>
          </div>
        </div>
      </div>
    </div>
